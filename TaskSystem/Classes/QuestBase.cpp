...
void UQuestBase::RefreshQuest()
{
	if (QuestDetails.StageDetails.IsValidIndex(CurrentStage))
	{
		...
		{
			if (FindInAllObjectives(Elem.ObjectiveID)) //ïğîâåğÿåì êàæäóş öåëü íà ïğèñóòñòâèå â ãëîáàëüíîì êâåñòîâîì ìàññèâå. çàùèòà îò ñîôòëîêà
			{
...
{
	//ëîãèêà îòêëş÷åíèÿ ïğåäûäóùèõ öåëåé, åñëè îíè îñòàëèñü, îòãğóçêà ñàáëåâåëà åñëè îí åñòü è òä
...
void UQuestBase::ObjectiveFailed(FString ObjectiveID, bool ForceUpdateStage)
{
	if (FindObjectiveByID(ObjectiveID))
	{
		...
		if (LocalObjective.ObjectiveDetails.bAllowFail == true || LocalObjective.ObjectiveDetails.bIsOptional == true)
		{
			...
			{
				// ÍÀÄÎ ÏÎÑÒÀÂÈÒÜ İÒÎ ÍÀ ÒÀÉÌÅĞ, ÏÎÒÎÌÓ ×ÒÎ ÈÃĞÎÊ ÍÅ ÂÈÄÈÒ ×ÒÎ ÑÒÀËÎ Ñ ÅÃÎ ÖÅËÜŞ È ÍÅ ÓÑÏÅÂÀÅÒ
				// ÏÎÍßÒÜ ×ÒÎ ÏĞÎÈÇÎØËÎ
...
{
	// íàäî äîáàâèòü âîçìîæíîñòü äîáàâëÿòü çàìåíó íà ñëåäóşùóş ñòàäèş
	// òîåñòü ñíà÷àëà ìû ïğîâåğÿåì AddToNextStage == true åñëè äà, òî äåëàåì àïğåéò ñòåéäæ
	// ÏĞÎÁËÅÌÀ: ÑÈÑÒÅÌÀ ÌÎÆÅÒ ÂÛÏÎËÍÈÒÜ ÊÂÅÑÒ ÏÎÑËÅ ÏĞÎÂÀËÅÍÍÎÉ ÖÅËÈ, ÅÑËÈ ÎÍÀ Â ÏÎÑËÅÄÍÅÉ ÑÒÀÄÈÈ
	// ÍÓÆÍÎ ÑÄÅËÀÒÜ ÇÀÙÈÒÓ ÎÒ İÒÎÃÎ ÁÓÄÅÒ
	// è ïîñëå àïäåéò ñòåéäæ ìû óæå äîáàâëÿåì íîâûå öåëè íà íîâóş ñòàäèş
	// à åñëè AddToNextStage == false òîãäà ïîõóé
	// ÍÎ: ÍÀÄÎ ÑÄÅËÀÒÜ ÏĞÎÂÅĞÊÓ ÍÀ ÖÅËÈ, ÍÅËÜÇß ÆÅ ÎÁÍÎÂËßÒÜ ÑÒÀÄÈŞ ÅÑËÈ ÍÅ ÂÑÅ ÖÅËÈ ÍÀ İÒÎÉ ÇÀÂÅĞØÅÍÛ
	// ÒÎËÜÊÎ ÅÑËÈ ÖÅËÜ, ÊÎÒÎĞÓŞ ÇÀÌÅÍÈËÈ ÎÑÒÀËÀÑÜ ÎÄÍÀ ÍÀ ÑÒÀÄÈÈ ÈËÈ ÁÛËÀ ÎÄÍÀ ÈÇÍÀ×ÀËÜÍÎ
